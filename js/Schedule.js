document.addEventListener("DOMContentLoaded", function() {
  ...
  function getFirstMondayOnOrAfterFirstDay(year, month) {
  ...
  function getWeekNumberFromFirstMonday(date) {
    const firstMonday = getFirstMondayOnOrAfterFirstDay(date.getFullYear(), date.getMonth());
  ...
  console.log('today:', today.toISOString().slice(0,10), 
              ...
              'firstMonday:', getFirstMondayOnOrAfterFirstDay(monday.getFullYear(), monday.getMonth()).toISOString().slice(0,10),
